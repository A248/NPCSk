...
@Examples({"Command /showall:", "\ttrigger:", "\t\tloop all players:", "\t\t\tloop all npcs:", "\t\t\tset visibility of loop-value-2 for loop-value-1 to true", "\t\tsend \"Now all players can see all NPCs\""})
@Since("0.8.0")
